...
- June 26, 2025. Migration complète de Replit Agent vers environnement Replit standard - toutes les dépendances installées, serveur fonctionnel sur port 5000, intégration frontend complète avec page anime-sama configurée avec l'API de production (https://api-anime-sama.onrender.com). Ajout du support de fichiers statiques, configuration centralisée API, interface utilisateur complète avec recherche, sélection d'épisodes et streaming vidéo.
